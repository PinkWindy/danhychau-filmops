...
def seed_end_customers(db: Session) -> None:
    ...
    _merge_customer(
        ...
        customer_name="KH_MASKED_LEXUS_115",
        customer_masked="KH_MASKED_LEXUS_115",
        phone_masked="PHONE_MASKED_115",
        address_masked="ADDRESS_MASKED_115",
        source_channel="OCR",
    ...
    _merge_customer(
        ...
        customer_name="KH_MASKED_LEXUS_117",
        customer_masked="KH_MASKED_LEXUS_117",
        phone_masked="PHONE_MASKED_117",
        address_masked="ADDRESS_MASKED_117",
        source_channel="OCR",
        source_dealer_id="DEALER_LEXUS_SG",
        crm_status="NEW_PENDING_VERIFICATION",
        status="ACTIVE",
    ...
    _merge_customer(
        ...
        customer_name="KH_MASKED_DIRECT_001",
        customer_masked="KH_MASKED_DIRECT_001",
    ...
    _merge_customer(
        ...
        customer_name="KH_MASKED_DEALER_001",
        customer_masked="KH_MASKED_DEALER_001",
...
def seed_vehicle_profiles(db: Session) -> None:
    ...
    _merge_vehicle(
        ...
        model_year=2026,
        vin_number="VIN_MASKED_RX350H_115",
    ...
    _merge_vehicle(
        ...
        model_name="RX350H PREMIUM CE",
        model_year=2026,
        vin_number="VIN_MASKED_RX350H_117",
    ...
    _merge_vehicle(
        ...
        model_year=2022,
        vin_number="VIN_MASKED_RX300_DEMO",
        vin_masked="VIN_MASKED_RX300_DEMO",
        vehicle_status="ACTIVE",
        created_at=ts,
    )
    _merge_vehicle(
        ...
        model_year=2024,
        vin_number="VIN_MASKED_ES250_DEMO",
        vin_masked="VIN_MASKED_ES250_DEMO",
        vehicle_status="ACTIVE",
        created_at=ts,
    )
    _merge_vehicle(
        ...
        model_year=2025,
        vin_number="VIN_MASKED_CAMRY_DEMO",
        vin_masked="VIN_MASKED_CAMRY_DEMO",
        vehicle_status="ACTIVE",
        created_at=ts,
    )
    _merge_vehicle(
        ...
        model_name="RX350H PREMIUM CE",
        model_year=2026,
        vin_number="VIN_MASKED_RX350_DEMO",
        vin_masked="VIN_MASKED_RX350_DEMO",
        vehicle_status="ACTIVE",
        created_at=ts,
    )
    _merge_vehicle(
        ...
        model_year=2025,
        vin_number="VIN_MASKED_UNKNOWN",
        vin_masked="VIN_MASKED_UNKNOWN",
        vehicle_status="ACTIVE",
        created_at=ts,
    )
...
def seed_req_20260604_for_inventory_smokes(db: Session) -> None:
    ...
    _merge_customer(
        ...
        customer_name="KH_MASKED_LEGACY_001",
        customer_masked="KH_MASKED_LEGACY_001",
        status="ACTIVE",
        created_at=ts,
    )
    _merge_vehicle(
        ...
        vin_masked="VIN_MASKED_RX350_VIP",
        vehicle_status="ACTIVE",
        created_at=ts,
    )
    wf_plan = json.dumps(
