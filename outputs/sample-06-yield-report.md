...
| `LOT-FILMA-001` | `JB20` (Window) | Đang dở dang | 30.00 | 17.50 | 12 đơn | 12 xe | 1.15 m | 6.57% |
| `LOT-FILMB-001` | `JB20` (Window) | Đang dở dang | 30.00 | 22.00 | 15 đơn | 15 xe | 1.80 m | 8.18% |
| `LOT-FILMC-001` | `RS20` (Window) | Đang dở dang | 30.00 | 8.00 | 5 đơn | 5 xe | 0.55 m | 6.87% |
...
* **Tình huống dán gom:** Thi công kính sườn và kính hậu cho Lexus RX350.
  ...
  * *Thực tế Cutting Group (`CG_RX350_SIDE_REAR`):* Gom cắt kính sườn (92x130) + kính hậu (60x130) trên block cuộn phim **152x130 cm**. Lượng phim trừ kho thực tế chỉ là **1.43m** từ cuộn gốc `LOT-FILMA-001`.
* **Hiệu quả:**
...
2. `LOT-FILMB-001` (`JB20`): Chiều dài còn lại **8.00 m**. Tốc độ tiêu thụ cao (trung bình 2.5m/ngày), dự kiến hết trong 3 ngày tới.
...
2. `SUBLOT-FILMA-002` (Kệ `OFFCUT-RACK-C`): Nhập kho ngày 2026-05-22. Kích thước dở dang: 1.0m x 2.5m.
